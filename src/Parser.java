...
{if ("" != null) return t1;}
  ...
  static final public ASTNode SE() throws ParseException {ASTNode t1, t2;
    t1 = boolAdd();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return t1;}
  ...
  static final public ASTNode relops() throws ParseException {ASTNode t1, t2;
    Token op;
    t1 = Exp();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EQUALTO:
...
{if ("" != null) return t1;}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x8000000,0x80000000,0x2000,0x1000,0x7c000,0x7c000,0x180000,0x180000,0x600000,0x600000,0x10,0x20000000,0x20900fe0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,};
	}
